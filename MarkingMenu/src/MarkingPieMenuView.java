...
public class MarkingPieMenuView extends JComponent {
    ...
    MarkingPieMenuView(int INNERCIRCLESIZE, int OUTERCIRCLESIZE, ArrayList<Section> sections) {
        highlight = -1;
    ...
    public void highlightSection(int sliceIndice) {
        Color c = slices.get(sliceIndice).getColor();
        highlight = sliceIndice;
        //slices[sliceIndice].setColor() = c.brighter();
        repaint();
    }
